...
public class Post_Complain_Controller implements ControllerI,Initializable {
	...
	public void submit_complain(ActionEvent event) throws IOException 
	{
		...
		if(check_form())
		{
			...
			controller.Login_win.showPopUp("ERROR", " Uncomplete- complain", "You have to fill all the required fields", "");
		}
	}
 ...
 */
	...
	{	cur_complain=new Complain();
    	...
    	user_id.setText(controller.Main_menu.current_user.getUser_ID());
