...
public class Cancel_Order_Controller  implements ControllerI,Initializable{
    ...
    */
    ...
    {
    	orders=controller.Active_Orders_Controller.order_history;
    	...
    	for(int i=0;i<orders.size();i++)
    	{
    		...
    		if(controller.Active_Orders_Controller.orderID_to_cancel.getId().equals(orders.get(i).getId()))
    		{
    ...
    public void CancelOrder(ActionEvent event) throws IOException
    {
    	...
    	return;}
    		...
    		for(int i=0;i<orders.size();i++)
    			if(orders.get(i).getId().equals(controller.Active_Orders_Controller.orderID_to_cancel.getId()))
    				o=orders.get(i);
    		...
    		msg.oldO=o;
    		msg.newO=controller.Main_menu.current_user;
