...
public class Update_Personal_Info_Controller implements ControllerI,Initializable {
	...
	/**Back button function*/
	 ...
	 public void update_details()
	 {
		 ...
		 msg.oldO=controller.Login_win.current_user;
	
		 
		 Person new_user_details=controller.Login_win.current_user; 
	 ...
	 public void get_new_user_details(Object message)
	 {
		...
		controller.Login_win.current_user=(Person) msg.newO;
	...
	Platform.runLater(new Runnable() {
		...
		public void run() {
			...
			controller.Login_win.showPopUp("INFORMATION", "UpDate was done!", "Your details were Successfully updated !", "");
		}
	});
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		display_cur_info(controller.Login_win.current_user);
		// TODO Auto-generated method stub
