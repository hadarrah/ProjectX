...
public class Profile_Controller implements ControllerI,Initializable {
	...
	public void set_user_details(Person user)
	{
		...
		if(!(controller.Login_win.current_user_pay_account.getCreditCard()==null)) 
		{
		 l_credit.setText("Credit Card:"+controller.Login_win.current_user_pay_account.getCreditCard());
		 l_subs.setText("Subscription:"+controller.Login_win.current_user_pay_account.getSubscription());
 		 l_status.setText("Status:"+controller.Login_win.current_user_pay_account.getStatus());
	 
		 if(controller.Login_win.current_user_pay_account.getRefund_sum()==null)
          l_balance.setText("Balance : 0");
		 else
		  l_balance.setText("Balance :"+Float.toString(controller.Login_win.current_user_pay_account.getRefund_sum())); 
		 }
		else {
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		set_user_details(controller.Login_win.current_user);
